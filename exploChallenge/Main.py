...
from exploChallenge.policies.BMPolicy import BMPolicy
    ...
    def main(self, argv=sys.argv):
        ...
        try:
            reader = YahooLogLineReader2(
                "/Users/ftruzzi/PycharmProjects/bmab/yahoo/data/ydata-fp-td-clicks-v2_0.201110", 2, 6, 136)
            logStep = 10000
        except:
